...
# the Document dataclass from Lesson 02. Safe to run more than once — an
# existing document is skipped, not duplicated. Build 05 replaces this with
# real Postgres seeding; the contract (idempotent, prints a summary, exits
# non-zero on real failure) stays the same.
